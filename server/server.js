...
//     service:"Gmail",
//     auth:{
//         user: "mohitankit1519@gmail.com",
//         pass:"ankitbhai"
//     }
// });

// var mail = {
//     from:"Ankitz <mohitankit1519@gmail.com>",
//     to:  "ankitagarwal9905@gmail.com",
//     subject:"Test Email",
//     text: "Testing mail ",
//     html:"<b>Hello Guys it works </b>"
// }
...
app.post('/api/users/addToCart',auth,(req,res)=>{
    ...
    if(duplicate){
        User.findOneAndUpdate(
            {_id:req.user.id,"cart.id":mongoose.Types.ObjectId(req.query.productId)}, 
            { $inc:{"cart.$.quantity":1}},
            {new:true},
            (err,doc)=>{
                if(err) return res.json({success:false,err});
...
app.post('/api/users/successBuy',auth,(req,res)=>{
    ...
    let transactionData = {}
    const date = new Date();
    const po = `Ankitz-${date.getDate()}/${date.getMonth()+1}-
    ${SHA1(req.user._id).toString().substring(0,6)}`
